    ...
    <Transition.Root show={isActive} as={Fragment}>
      ...
      >
        <div className="flex h-full w-full items-end justify-center sm:items-center">
          ...
          >
            <div className="w-full transform rounded-t-xl bg-white px-6 py-8 text-gray-700 shadow-xl transition-all sm:max-w-sm sm:rounded-xl">
              <div className="mb-6 flex select-none items-center justify-between">
                <div className="group relative">
                  <button
                    className="text-zinc-400/75 transition duration-300 ease-in-out hover:text-indigo-600"
                    onClick={() => {
                      disconnect()
                      onClose()
                    }}
                  ...
                  <span className="absolute hidden rounded bg-black px-2 py-1 text-xs text-white group-hover:inline-block">
                    Disconnect
                  </span>
                </div>
